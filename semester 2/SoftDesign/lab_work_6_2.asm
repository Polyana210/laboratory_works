;факториалы чисел от 1 до N; числа заканчивающиеся на чётное количество цифр 0 (включая цифры,
;заканчивающиеся цифрой отличной от 0) заменяются на свою самую левую ненулевую цифру.
